...
// Madi
#define ABILITY_ENLIGHTENMENT ABILITIES_COUNT_ROGUE + 1
#define ABILITY_VOODOO_CURSE ABILITIES_COUNT_ROGUE + 2
#define ABILITY_THERMAL_BOOST ABILITIES_COUNT_ROGUE + 3
#define ABILITY_EVIL_EYE ABILITIES_COUNT_ROGUE + 4
#define ABILITY_SIRENS_SONG ABILITIES_COUNT_ROGUE + 5
#define ABILITY_DARK_CURRENT ABILITIES_COUNT_ROGUE + 6

#define ABILITIES_COUNT_ROGUE_MADI ABILITIES_COUNT_ROGUE + 7

#define ABILITIES_COUNT ABILITIES_COUNT_ROGUE_MADI
