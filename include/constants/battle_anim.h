...
#define ANIM_TAG_IVY_CUDGEL_GRASS           (ANIM_SPRITES_START + 396)
#define ANIM_TAG_IVY_CUDGEL_FIRE            (ANIM_SPRITES_START + 397)
#define ANIM_TAG_IVY_CUDGEL_ROCK            (ANIM_SPRITES_START + 398)
#define ANIM_TAG_IVY_CUDGEL_WATER           (ANIM_SPRITES_START + 399)
...
#define LAST_ANIM_TAG                       ANIM_TAG_TATSUGIRI_STRETCHY
