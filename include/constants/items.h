...
#define ITEM_ROGUE_ITEM_COUNT   156
#define ITEM_ROGUE_ITEM_FIRST   827
#define ITEM_ROGUE_ITEM_LAST    (ITEM_ROGUE_ITEM_FIRST + ITEM_ROGUE_ITEM_COUNT - 1)

#define ITEM_GEN_9_MEGA_STONES_ITEM_COUNT   45
#define ITEM_GEN_9_MEGA_STONES_FIRST (ITEM_ROGUE_ITEM_LAST + 1)
#define ITEM_GEN_9_MEGA_STONES_LAST (ITEM_GEN_9_MEGA_STONES_FIRST + ITEM_GEN_9_MEGA_STONES_ITEM_COUNT - 1)

#define ITEM_CLEFABLITE (ITEM_GEN_9_MEGA_STONES_FIRST + 0)
#define ITEM_VICTREEBELITE (ITEM_GEN_9_MEGA_STONES_FIRST + 1)
#define ITEM_STARMINITE (ITEM_GEN_9_MEGA_STONES_FIRST + 2)
#define ITEM_DRAGONINITE (ITEM_GEN_9_MEGA_STONES_FIRST + 3)
#define ITEM_MEGANIUMITE (ITEM_GEN_9_MEGA_STONES_FIRST + 4)
#define ITEM_FERALIGITE (ITEM_GEN_9_MEGA_STONES_FIRST + 5)
#define ITEM_SKARMORITE (ITEM_GEN_9_MEGA_STONES_FIRST + 6)
#define ITEM_FROSLASSITE (ITEM_GEN_9_MEGA_STONES_FIRST + 7)
#define ITEM_EMBOARITE (ITEM_GEN_9_MEGA_STONES_FIRST + 8)
#define ITEM_EXCADRITE (ITEM_GEN_9_MEGA_STONES_FIRST + 9)
#define ITEM_SCOLIPITE (ITEM_GEN_9_MEGA_STONES_FIRST + 10)
#define ITEM_SCRAFTINITE (ITEM_GEN_9_MEGA_STONES_FIRST + 11)
#define ITEM_EELEKTROSSITE (ITEM_GEN_9_MEGA_STONES_FIRST + 12)
#define ITEM_CHANDELURITE (ITEM_GEN_9_MEGA_STONES_FIRST + 13)
#define ITEM_CHESNAUGHTITE (ITEM_GEN_9_MEGA_STONES_FIRST + 14)
#define ITEM_DELPHOXITE (ITEM_GEN_9_MEGA_STONES_FIRST + 15)
#define ITEM_GRENINJITE (ITEM_GEN_9_MEGA_STONES_FIRST + 16)
#define ITEM_PYROARITE (ITEM_GEN_9_MEGA_STONES_FIRST + 17)
#define ITEM_FLOETTITE (ITEM_GEN_9_MEGA_STONES_FIRST + 18)
#define ITEM_MALAMARITE (ITEM_GEN_9_MEGA_STONES_FIRST + 19)
#define ITEM_BARBARACITE (ITEM_GEN_9_MEGA_STONES_FIRST + 20)
#define ITEM_DRAGALGITE (ITEM_GEN_9_MEGA_STONES_FIRST + 21)
#define ITEM_HAWLUCHANITE (ITEM_GEN_9_MEGA_STONES_FIRST + 22)
#define ITEM_ZYGARDITE (ITEM_GEN_9_MEGA_STONES_FIRST + 23)
#define ITEM_DRAMPANITE (ITEM_GEN_9_MEGA_STONES_FIRST + 24)
#define ITEM_FALINKSITE (ITEM_GEN_9_MEGA_STONES_FIRST + 25)
#define ITEM_HEATRANITE (ITEM_GEN_9_MEGA_STONES_FIRST + 26)
#define ITEM_DARKRANITE (ITEM_GEN_9_MEGA_STONES_FIRST + 27)
#define ITEM_ZERAORITE (ITEM_GEN_9_MEGA_STONES_FIRST + 28)
#define ITEM_RAICHUNITE_X (ITEM_GEN_9_MEGA_STONES_FIRST + 29)
#define ITEM_RAICHUNITE_Y (ITEM_GEN_9_MEGA_STONES_FIRST + 30)
#define ITEM_CHIMECHITE (ITEM_GEN_9_MEGA_STONES_FIRST + 31)
#define ITEM_ABSOLITE_Z (ITEM_GEN_9_MEGA_STONES_FIRST + 32)
#define ITEM_STARAPTITE (ITEM_GEN_9_MEGA_STONES_FIRST + 33)
#define ITEM_GARCHOMPITE_Z (ITEM_GEN_9_MEGA_STONES_FIRST + 34)
#define ITEM_LUCARIONITE_Z (ITEM_GEN_9_MEGA_STONES_FIRST + 35)
#define ITEM_GOLURKITE (ITEM_GEN_9_MEGA_STONES_FIRST + 36)
#define ITEM_MEOWSTICITE (ITEM_GEN_9_MEGA_STONES_FIRST + 37)
#define ITEM_CRABOMINITE (ITEM_GEN_9_MEGA_STONES_FIRST + 38)
#define ITEM_GOLISOPITE (ITEM_GEN_9_MEGA_STONES_FIRST + 39)
#define ITEM_MAGEARNITE (ITEM_GEN_9_MEGA_STONES_FIRST + 40)
#define ITEM_SCOVILLAINITE (ITEM_GEN_9_MEGA_STONES_FIRST + 41)
#define ITEM_BAXCALIBRITE (ITEM_GEN_9_MEGA_STONES_FIRST + 42)
#define ITEM_TATSUGIRINITE (ITEM_GEN_9_MEGA_STONES_FIRST + 43)
#define ITEM_GLIMMORANITE (ITEM_GEN_9_MEGA_STONES_FIRST + 44)

#define ITEMS_COUNT             (ITEM_GEN_9_MEGA_STONES_LAST + 1)
