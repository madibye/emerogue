...
#define ITEM_ROGUE_ITEM_LAST    (ITEM_ROGUE_ITEM_FIRST + 155)
...
#define ITEM_GEN_9_MEGA_STONES_LAST (ITEM_GEN_9_MEGA_STONES_FIRST + 44)
#define ITEM_GEN_9_MEGA_STONES_ITEM_COUNT   (ITEM_GEN_9_MEGA_STONES_LAST - ITEM_GEN_9_MEGA_STONES_FIRST + 1)
