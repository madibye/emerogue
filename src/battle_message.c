...
static const u8 sText_PoisonPuppeteer[] = _("{B_PLAYER_MON1_NAME}'s Poison Puppeteer\nhas confused {B_OPPONENT_MON1_NAME}!");
...
static const u8 sText_BadDreamsDmg[] = _("{B_DEF_NAME_WITH_PREFIX} is tormented by\n{B_ATK_NAME_WITH_PREFIX}'s Bad Dreams!");
static const u8 sText_EvilEyeDmg[] = _("{B_DEF_NAME_WITH_PREFIX} can't escape\n{B_ATK_NAME_WITH_PREFIX}'s Evil Eye!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_EVILEYEDMG - BATTLESTRINGS_TABLE_START] = sText_EvilEyeDmg,
