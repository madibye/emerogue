...
#define BANETTE_MISC_INFO                                           \
    ...
    [SPECIES_BANETTE_MEGA] =
    {
        ...
        .baseSpDefense = 83,
        .expYield = 194,
        .abilities = { ABILITY_VOODOO_CURSE, ABILITY_VOODOO_CURSE, ABILITY_VOODOO_CURSE },
    ...
    [SPECIES_CHIMECHO_MEGA] =
    {
        ...
        //.shinyPalette = gMonShinyPalette_CircledQuestionMark,z
...
#define ABSOL_MISC_INFO                                     \
    ...
    [SPECIES_ABSOL_MEGA_Z] =
    {
        ...
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_AbsolMegaZ,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
