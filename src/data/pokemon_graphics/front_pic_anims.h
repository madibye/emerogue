...
PLACEHOLDER_ANIM_SINGLE_FRAME(AbsolMegaZ);
PLACEHOLDER_ANIM_SINGLE_FRAME(StaraptorMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(GarchompMegaZ);
PLACEHOLDER_ANIM_SINGLE_FRAME(LucarioMegaZ);
PLACEHOLDER_ANIM_SINGLE_FRAME(HeatranMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(DarkraiMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(ScolipedeMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(ScraftyMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(EelektrossMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(ZygardeMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(GolisopodMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(MagearnaMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(MagearnaOriginalMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(ZeraoraMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(FalinksMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(TatsugiriCurlyMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(TatsugiriDroopyMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(TatsugiriStretchyMega);
PLACEHOLDER_ANIM_SINGLE_FRAME(BaxcaliburMega);
...
SINGLE_ANIMATION(AbsolMegaZ);
SINGLE_ANIMATION(StaraptorMega);
SINGLE_ANIMATION(GarchompMegaZ);
SINGLE_ANIMATION(LucarioMegaZ);
SINGLE_ANIMATION(HeatranMega);
SINGLE_ANIMATION(DarkraiMega);
SINGLE_ANIMATION(ScolipedeMega);
SINGLE_ANIMATION(ScraftyMega);
SINGLE_ANIMATION(EelektrossMega);
...
SINGLE_ANIMATION(ZygardeMega);
SINGLE_ANIMATION(GolisopodMega);
SINGLE_ANIMATION(MagearnaMega);
SINGLE_ANIMATION(MagearnaOriginalMega);
SINGLE_ANIMATION(ZeraoraMega);
SINGLE_ANIMATION(FalinksMega);
SINGLE_ANIMATION(TatsugiriCurlyMega);
SINGLE_ANIMATION(TatsugiriDroopyMega);
SINGLE_ANIMATION(TatsugiriStretchyMega);
