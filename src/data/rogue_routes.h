...
static const struct RogueEncounterMap sRogueTeamEncounters[] = 
{
    ...
    ENCOUNTER_MAP(TEAM_NUM_PLASMA, ROGUE_ENCOUNTER_AQUA_HIDEOUT),
    ENCOUNTER_MAP(TEAM_NUM_PLASMA + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_GALACTIC_HQ),

    ENCOUNTER_MAP(TEAM_NUM_NEOPLASMA, ROGUE_ENCOUNTER_AQUA_HIDEOUT),
    ENCOUNTER_MAP(TEAM_NUM_NEOPLASMA + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_GALACTIC_HQ),

    ENCOUNTER_MAP(TEAM_NUM_FLARE, ROGUE_ENCOUNTER_LAKE_VALOR),
    ENCOUNTER_MAP(TEAM_NUM_FLARE + TEAM_PRE_LEGEND_MAP_OFFSET, ROGUE_ENCOUNTER_MAGMA_HIDEOUT),
};
